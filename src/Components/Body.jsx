    ...
    <div>
      ...
      <Banner data={banner} /> */}
        ...
        <div className="category-buttons max-sm:flex justify-center gap-2 flex-wrap">
          ...
          <Button className="btncat" variant="outlined" onClick={showPureVeg}>
            PURE VEG 💚
          </Button>
          <Button
            className="btncat"
            variant="outlined"
            onClick={showPureNonVeg}
          >
            Non-Veg 🔴
          </Button>
          <Button className="btncat" variant="outlined" onClick={rangeFirst}>
            💰 Rs.300 - Rs.600
          </Button>
          <Button className="btncat" variant="outlined" onClick={lessThanSix}>
            💰 Less than 600
          </Button>
        </div>
