...
const CartItemList = ({ ele }) => {
  ...
  return (
    <div className="max-md:flex justify-center">
      <div className="fetchOrderList max-md:hidden">
        <div className="fetchOrderSec1">
          <img
            className="w-16 rounded-lg  mt-4"
            src={
              imageId
        ...
        <div className="fetchOrderIncDec ">
          <Button
            className="dltBtn"
            onClick={() => deleteQuantity(name, price || defaultPrice)}
          >
            <DeleteIcon />
          </Button>
          <input
          ...
          <Button
            className="addBtn"
            onClick={() => addQuantity(name, price || defaultPrice)}
          >
            <AddIcon />
          </Button>
        </div>
        ...
        <div className="fetchOrderDltbutton ">
          <Button
            ...
            className="btnDelete"
            onClick={() =>
              cancelItem(name, price * quantity || defaultPrice * quantity)
            }
          >
            Cancel
          </Button>
      ...
      <div className=" border border-b-4 border-t-0 border-l-0 border-r-0 mt-6 flex justify-center items-center flex-wrap w-[50%] max-sm:w-[95%] md:hidden ">
        <div className="flex flex-col justify-center items-center gap-2">
       
          <img
            className="w-16 rounded-xl mt-4"
            src={
              imageId
                ? "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,c_fill/" +
                  imageId
